...
public class NetworkUtil {
    ...
    public static InetAddress getLocalAddress(boolean preferIPv6) {
        ...
        Set<String> virtualNetworkInterfaces = new HashSet<>(
            Arrays.asList("vmware", "virtual", "hyper-v", "vbox", "virtualbox"));
